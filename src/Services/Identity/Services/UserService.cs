namespace Identity.WebApi.Services
{
    ...
    public interface IUserService
    {
        ...
        IEnumerable<int> GetAccountNumbers();
        IEnumerable<UserAccount> GetUserAccounts();
        UserAccount GetUserAccount(int accountNumber);
    }
    ...
    public class UserService : IUserService
    {
        ...
        {
            return _users.Select(i => i.AccountNumber);
        }

        public IEnumerable<UserAccount> GetUserAccounts()
        {
            return _users.Select(i => new UserAccount() { Name = i.FullName, AccountNumber = i.AccountNumber, Currency = i.Currency });
        }

        public UserAccount GetUserAccount(int accountNumber)
        {
            return _users
                .Select(i => new UserAccount() { Name = i.FullName, AccountNumber = i.AccountNumber, Currency = i.Currency })
                .FirstOrDefault(i => i.AccountNumber == accountNumber);
        }
    }
}
